...
object StatusBarUtil {
    ...
    @JvmOverloads fun setColor(activity: Activity, @ColorInt color: Int, statusBarAlpha: Int = DEFAULT_STATUS_BAR_ALPHA) {
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    @JvmOverloads fun setColorForDrawerLayout(activity: Activity, drawerLayout: DrawerLayout, @ColorInt color: Int,
